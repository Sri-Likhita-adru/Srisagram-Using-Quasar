          ...
          >
            ...
            <q-item>
              <q-item-section avatar>
                <q-avatar>
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKOADoRyUTR-bfwTe7CrWTy3uqpybRXOozgQ&usqp=CAU">
                </q-avatar>
              </q-item-section>

              <q-item-section>
                <q-item-label class="text-bold">_.sweet._.sugar._</q-item-label>
...
export default {
  ...
  methods: {
    ...
    createPushSubscription(reg) {
      let vapidPublicKey = 'BG8qpMxhUWVFJAwWm6DI9vzZpJPwoKOBT4Coo5wd8lvDxRgsyTBEbQDEeuNC7ooh455d1c73IzR4kO3L4psfHeI'
